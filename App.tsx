...
// --- Sub-Components (View Sections) ---

const HomeView = ({ isActive, handleNav }: { isActive: boolean; handleNav: (v: any) => void }) => {
  return (
    <div className={`template color-yellow ${isActive ? 'current' : ''}`} data-template="home">
...
const ExperienceView = ({ isActive, handleNav }: { isActive: boolean; handleNav: (v: any) => void }) => {
  return (
    <div className={`template color-yellow ${isActive ? 'current' : ''}`} data-template="experience">
      <main>
...
const ProjectsView = ({ isActive, handleNav }: { isActive: boolean; handleNav: (v: any) => void }) => {
  return (
    <div className={`template color-blue ${isActive ? 'current' : ''}`} data-template="projects">
      <main>
...
const AboutView = ({ isActive, handleNav }: { isActive: boolean; handleNav: (v: any) => void }) => {
  return (
    <div className={`template color-green ${isActive ? 'current' : ''}`} data-template="about">
      <main>
  ...
  return (
    <div className="wrapper" style={{ position: 'relative', width: '100%', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        <HomeView isActive={view === 'home'} handleNav={handleNav} />
        <ExperienceView isActive={view === 'experience'} handleNav={handleNav} />
        <ProjectsView isActive={view === 'projects'} handleNav={handleNav} />
        <AboutView isActive={view === 'about'} handleNav={handleNav} />
